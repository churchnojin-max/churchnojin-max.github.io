...
--   monthly_song : 이달의 찬양(유튜브 링크·악보) — 홈/말씀으로 페이지 공개 표시
-- Supabase 대시보드 → SQL Editor 에 붙여넣고 Run 한 번 실행하세요. (재실행해도 안전합니다)
-- ============================================================
...
create policy "public read display settings"
  ...
  for select
  using (key in ('homepage', 'committees', 'general', 'monthly_song'));
