-- ============================================================
-- 노진교회 홈페이지 업그레이드 (2026-07-23) — 이 파일 하나만 실행하면 됩니다
-- Supabase(노진교회 계정) → SQL Editor → 전체 붙여넣기 → Run
-- 내용: 찬양곡 라이브러리 + 예배 찬양 배정 + 메모 보드 + 회원 정지 + 찬양 937곡 데이터
-- 여러 번 실행해도 안전합니다.
-- ============================================================
